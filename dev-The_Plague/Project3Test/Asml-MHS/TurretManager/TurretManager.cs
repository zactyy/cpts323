...
namespace TurretManagement
{
    public class TurretManager// class manages turret status
    {
        ...
        private TurretManager()
        {
            ...
            this.GET_STATUS = new byte[10];
            this.GET_STATUS[0] = 0x04;
            ...
            this.USB.OnDataRecieved += new DataRecievedEventHandler(this.USB_OnDataRecievedEventHandler);
            ...
            this._launcher_status = new byte[10];
        ...
        {
            ThetaY += degrees;
            this.command_Up(Convert.ToInt32(degrees * MILLISECONDS_PER_DEGREE));
        }
        /// <summary>
        /// take an integer argument for the number of
        ...
        {
            ThetaY -= degrees;
            this.command_Down(Convert.ToInt32(degrees * MILLISECONDS_PER_DEGREE));
        }
        ...
        {
            ThetaX += degrees;
            this.command_Right(Convert.ToInt32(degrees * MILLISECONDS_PER_DEGREE));
        }
        ...
        {
            ThetaX -= degrees;
            this.command_Left(Convert.ToInt32(degrees * MILLISECONDS_PER_DEGREE));
        }
